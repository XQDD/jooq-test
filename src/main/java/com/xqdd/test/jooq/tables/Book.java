 ...
 */
package com.xqdd.test.jooq.tables;


import com.xqdd.test.jooq.Indexes;
import com.xqdd.test.jooq.Keys;
import com.xqdd.test.jooq.Public;
...
public class Book extends TableImpl<BookRecord> {
    ...
    private static final long serialVersionUID = 1951118593;
     ...
     */
    public final TableField<BookRecord, String> NAME = createField("NAME", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>PUBLIC.BOOK.PAGENUM</code>.
     */
    public final TableField<BookRecord, Integer> PAGENUM = createField("PAGENUM", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.FK5GBO4O7YXEFXIVWUQJICHC67T_INDEX_1, Indexes.PRIMARY_KEY_1);
    }
    ...
    public List<ForeignKey<BookRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<BookRecord, ?>>asList(Keys.FK5GBO4O7YXEFXIVWUQJICHC67T);
    }

    public Author author() {
        return new Author(this, Keys.FK5GBO4O7YXEFXIVWUQJICHC67T);
    }
